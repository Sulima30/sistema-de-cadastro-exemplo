...
function PesquisarFornecedor() {
  ...
  const fetchMovimentacoes = async () => {
    try {
      const response = await axios.get('http://localhost:4000/api/Pesquisar-Fornecedores', {
        params: {
          page,
          limit: itemsPerPage,
          search,
  ...
  const handleEditarCliente = (codCliente) => {
    ...
    router.push(`/Atualizar-Fornecedor?codCliente=${codCliente}`);
  };
      ...
      <div className='page-holder fundo-formulario-sl'>
        <div className="container-fluid px-lg-4">
          <Breadcump
            ...
            segundoNivel={"Pesquisar Fornecedor"}
          />
          <section>
              ...
              <div className="card-body">
                ...
                <div className='row'>
                  <div className="col-lg-2 mt-3">
                    <Link href={'/Cadastros/Cadastro-Fornecedor'}>
