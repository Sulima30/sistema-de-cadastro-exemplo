...
function PesquisarCliente() {
  ...
  const filteredMovimentacoes = movimentacoes.filter(mov =>
    mov.nomeCompleto.toLowerCase().includes(search.toLowerCase()) ||
  ...
  const fetchMovimentacoes = async () => {
    try {
      const response = await axios.get('http://localhost:4000/api/Pesquisar-Clientes-PF', {
        params: {
          page,
          limit: itemsPerPage,
          search,
              ...
              <div className="card-body">
                ...
                <div className='row'>
                  <div className="col-lg-2 mt-3">
                    <Link href={'/Cadastros/Cadastro-Pessoa-Fisica'}>
