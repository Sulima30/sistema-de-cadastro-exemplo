...
function CadastroPessoaJuridica() {
  ...
  const handleFinalizarCadastro = async () => {
    ...
    try {
      const response = await axios.post('http://localhost:4000/api/Cadastrar-Cliente-PJ', formData);
      ...
      <div className='page-holder fundo-formulario-sl'>
        ...
        <div class="container-fluid px-lg-4 ">
          <Breadcump
            ...
            segundoNivel={"Cliente Pessoa Jurídica"}
          />
          <div class="page-header">
            <h4 class="page-heading">Cadastro de Clientes - Pessoa Jurídica</h4>
          </div>
          <section>
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <div className='row'>
                    ...
                    <div class="col-lg-4">
                      <InputWithLabel id="tipoEnd" defaultValue="Não Informado" tipoInput={'text'} label={"Bairro"} value={formData.tipoEnd} handleChange={handleChange} required />
                    </div>
                    <div class="col-lg-3">
                      <InputWithLabel
                        id={"complementoEnd"}
                    ...
                    <div class="col-lg-1">
                      <InputWithLabel id="tipoUF" defaultValue="Não Informado" tipoInput={'text'} label={"UF"} value={formData.tipoUF} handleChange={handleChange} required />
                    </div>
                  </div>
                </div>
